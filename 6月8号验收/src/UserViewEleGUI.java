...
public class UserViewEleGUI extends UserViewEnergyGUI{

    public UserViewEleGUI() {
        super();
        UserHistoryLogic myEle = new UserHistoryLogic(session.getUsername(), "ele");
        myEle.HistoryByDay();
        ArrayList<UserHistoryEntity> myHistoryList = (ArrayList<UserHistoryEntity>) myEle.returnHistoryList.clone();
        ...
        btnHistoryBill.addActionListener(e -> {
            new UserHistoryGUI(session.getUsername(), "ele").setVisible(true);
            dispose();
            //一会儿再说
        });
        ...
        btnReturn.addActionListener(e -> {
            ...
            UserDAO.writeCurrentFile(session.getUsername(), "ele", energyConsumeEntity);
